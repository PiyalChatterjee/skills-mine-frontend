...
// ΓöÇΓöÇ Shared sub-components ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ ProfilePage ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
const ProfilePage = () => {
  ...
  return (
    <Box className={styles.pageRoot}>
      ...
      />
      {/* ΓöÇΓöÇ Page heading ΓöÇΓöÇ */}
      <Typography component="h1" className={styles.pageTitle}>
        Profile settings
      </Typography>

      <Box className={styles.layout}>
        {/* ΓöÇΓöÇ Left: Form sections ΓöÇΓöÇ */}
        <Stack className={styles.formStack}>
          {/* ΓöÇΓöÇ Personal details ΓöÇΓöÇ */}
          <SectionCard
          ...
          >
            <Box className={styles.educationBody}>
              {/* Cert grid: label + 3 cert rows + add button ΓÇö all full-width */}
              ...
              {/* Highest degree ΓÇö full-width, below cert grid */}
              <ProfileTextField
                control={control}
        ...
        {/* ΓöÇΓöÇ Right: Profile photo sidebar ΓöÇΓöÇ */}
