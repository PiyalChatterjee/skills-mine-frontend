    ...
    <Box className={`${styles.previewPageDocument} ${size === 'compact' ? styles.previewPageDocumentCompact : ''}`}>
      ...
      <Box className={styles.previewPageBody}>
        ...
        <Box className={styles.previewPageOverviewLines}>
          <Typography><strong>Years of experience:</strong> Overall: {yearsOfExperience}</Typography>
          <Typography><strong>Highest Qualification:</strong> {highestQualification}</Typography>
          <Typography><strong>Industry Experience:</strong> {industryExperience}</Typography>
        </Box>
